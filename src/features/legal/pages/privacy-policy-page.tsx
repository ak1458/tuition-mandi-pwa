  ...
  return (
    <PageShell>
      ...
      <article className="px-5 py-5 pb-20 space-y-6">
        ...
        <section className="rounded-[18px] border border-[#fcefd2] bg-marigold-wash p-4">
          <h2 className="text-[14px] font-black text-marigold-deep">🔒 Your Data, Your Choice</h2>
          <p className="mt-2 text-[12px] font-semibold leading-6 text-ink-2">
        ...
        <Section title="4. Third-Party Services">
          <ul className="list-disc pl-4 space-y-2">
            ...
            <li><strong>Razorpay (India):</strong> Payment processing for Pro plan subscriptions. Subject to <a className="text-marigold-deep underline" href="https://razorpay.com/privacy/" target="_blank" rel="noreferrer">Razorpay&apos;s Privacy Policy</a>.</li>
        ...
        <Section title="9. Grievance Officer (IT Rules 2021)">
          <div className="rounded-xl border border-line bg-surface-2 p-3 mt-2">
            <p><strong>Grievance Officer:</strong> TuitionMandi Support Team</p>
            <p><strong>Email:</strong> <a className="text-marigold-deep underline" href={`mailto:${GRIEVANCE_EMAIL}`}>{GRIEVANCE_EMAIL}</a></p>
